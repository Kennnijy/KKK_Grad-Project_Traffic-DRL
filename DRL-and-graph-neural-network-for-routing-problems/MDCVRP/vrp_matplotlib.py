...
def vrp_matplotlib(Greedy=True):
    ...
    node_ = np.loadtxt('vrp100_test_data.csv', dtype=float, delimiter=',')
    demand_=np.loadtxt('vrp100_demand.csv', dtype=float, delimiter=',')
    capcity_=np.loadtxt('vrp100_capcity.csv', dtype=float, delimiter=',')
